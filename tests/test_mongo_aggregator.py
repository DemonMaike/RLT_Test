...
@pytest.fixture
def mongo_aggregator():
    return MongoAggregator(uri=MONGO_URI, db_name=DB_NAME, collection_name=COLLECTION_NAME)

@pytest.mark.asyncio
async def test_aggregate_data_month(mongo_aggregator):
    ...
    result = await mongo_aggregator.aggregate_data(period_data)
...
@pytest.mark.asyncio
async def test_aggregate_data_day(mongo_aggregator):
    period_data = PeriodData(
...
@pytest.mark.asyncio
async def test_aggregate_data_hour(mongo_aggregator):
    period_data = PeriodData(
...
@pytest.mark.asyncio
async def test_aggregate_data_week(mongo_aggregator):
    period_data = PeriodData(
        dt_from="2022-10-01T00:00:00",
        dt_upto="2022-12-31T23:59:00",
        group_type="week"
    ...
    expected_result = {
        "dataset": [0, 990748, 1370706, 1382226, 1383792, 1368756, 1359287, 1408124, 1363540, 1374937, 1374749, 1381270, 1375875, 1364301],
        "labels": ['2022-09-25T00:00:00', '2022-10-02T00:00:00', '2022-10-09T00:00:00', '2022-10-16T00:00:00', '2022-10-23T00:00:00', '2022-10-30T00:00:00', '2022-11-06T00:00:00', '2022-11-13T00:00:00', '2022-11-20T00:00:00', '2022-11-27T00:00:00', '2022-12-04T00:00:00', '2022-12-11T00:00:00', '2022-12-18T00:00:00', '2022-12-25T00:00:00']
    }
